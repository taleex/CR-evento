...
export default function EventCard({ event }: EventCardProps) {
  ...
  return (
    <MotionLink ref={ref} className="flex-1 basis-80 h-[380px] max-w-[500px]" href={`/event/${event.slug}`}
     style={{
        // @ts-ignore
        scale: scaleProgress, opacity: opacityProgress }} initial={ {opacity:0, scale:0.8} }>
